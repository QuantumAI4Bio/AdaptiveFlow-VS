...
* [Jobs/joblines can be stopped](broken-reference)
* [Jobs/joblines can be continued](broken-reference)
* [Joblines can be modified (during the runtime)](broken-reference)
...
During the runtime, or during times where joblines are stopped, joblines can be modified via the _**control files**_ as specified [here](broken-reference) in the section[ Preparing the Workflow](broken-reference).
