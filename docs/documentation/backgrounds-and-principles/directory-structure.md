...
The `input-files` folder contains files that are not part of the VirtualFlow 2.0 code, but are provided by the user as input files. E.g. in the case of AFVS, it will contain the configuration files for the docking programs.
