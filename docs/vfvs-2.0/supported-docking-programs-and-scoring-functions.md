...
3. For an example of the`config.txt` file, please refer to [the VituralFlow 2.0 github repository](https://github.com/VirtualFlow/VFVS/blob/python-develop/tools/templates/DOCKING_SOFTWARE_NOTES.md).&#x20;
