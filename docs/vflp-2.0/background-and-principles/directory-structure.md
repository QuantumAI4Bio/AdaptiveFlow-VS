...
The directory structure of VFLP 2.0 is the same as that for VirtualFlow 2.0 in general (as described [here](../../documentation/backgrounds-and-principles/directory-structure.md)).
