...
The directory structure of AFLP is the same as that for AdaptiveFlow in general (as described [here](../../documentation/backgrounds-and-principles/directory-structure.md)).
