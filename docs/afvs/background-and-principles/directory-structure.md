...
The structure of the `output-files` folder is described [here](../../documentation/backgrounds-and-principles/directory-structure.md#the-output-files-folder)[ ](../../documentation/backgrounds-and-principles/directory-structure.md)about AdaptiveFlow in general.
...
The `results` folder contains the original docking output files of the docking programs in the AdaptiveFlow database format as described [here](../../documentation/backgrounds-and-principles/input-and-output-databases.md).
