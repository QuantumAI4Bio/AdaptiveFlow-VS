...
The usage of VFVS is the same as the usage of VirtualFlow in general, which is described [here](broken-reference).&#x20;

In addition for VFVS the input-files folder has to be prepared set up as described [here](broken-reference).&#x20;
