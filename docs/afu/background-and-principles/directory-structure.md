...
The general structure of the `output-files` folder is described [here](broken-reference) about AdaptiveFlow in general.
...
The `results` folder contains the original docking output files of the docking programs in the AdaptiveFlow database format as described [here](broken-reference).
